...
| `plan/02_source_sync.md` | `features/01_source_sync_and_updates.md` | `acceptance-cases/01_source_sync.md` | `src/crawler.rs`, `src/parser.rs`, `src/db/write.rs` | limited sync + update check smoke |
